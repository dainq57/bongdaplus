...
public class GermanyResultFragment extends Fragment{
	
	private String url = "http://thethao247.vn/bundesliga-live63/";
	...
	private  GermanyResultFragment instance=null;
	
	
	public  GermanyResultFragment getInstance (){
		if( instance!=null) return instance;
		else {
			instance=new GermanyResultFragment();
			return instance;
		}
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		new GermanyResultAsyncTask().execute();
	...
	private class GermanyResultAsyncTask extends AsyncTask<String, String, ArrayList<ResultItem>> {	
