...
public class SpainResultFragment extends Fragment{
	
	private String url = "http://thethao247.vn/la-liga-live58/";
	...
	private  SpainResultFragment instance=null;
	
	
	public  SpainResultFragment getInstance (){
		if( instance!=null) return instance;
		else {
			instance=new SpainResultFragment();
			return instance;
		}
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		new SpainResultAsyncTask().execute();
	...
	private class SpainResultAsyncTask extends AsyncTask<String, String, ArrayList<ResultItem>> {	
