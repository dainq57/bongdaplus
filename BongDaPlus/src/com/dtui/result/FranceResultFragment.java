...
public class FranceResultFragment extends Fragment{
	
	private String url = "http://thethao247.vn/ligue-1-live73/";
	...
	private  FranceResultFragment instance=null;
	
	
	public  FranceResultFragment getInstance (){
		if( instance!=null) return instance;
		else {
			instance=new FranceResultFragment();
			return instance;
		}
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		new FranceResultAsyncTask().execute();
	...
	private class FranceResultAsyncTask extends AsyncTask<String, String, ArrayList<ResultItem>> {	
